...
public class AdvancedValidationTest {
    ...
    void testValidate() {
        ...
        Map<String, List<String>> excpected1 =
                Map.of(
                        "country", List.of("length less than 4"),
                        "street", List.of("can not be null", "length less than 4")
                );

        var result1 = Validator.advancedValidate(address);
        assertThat(result1).isEqualTo(excpected1);
        /*
